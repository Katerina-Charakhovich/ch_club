            ...
            <c:if test="${not empty authUser}">
                <div id="commentAddBlock" hidden>
                    <form action="${pageContext.request.contextPath}/do" method="post">
                        ...
                        <textarea formenctype="text/plain;charset= UTF-8" rows="3" class="form-control"
                                  id="eventMessage" name="eventMessage"
                                  placeholder=<fmt:message key="event.comment"/>></textarea>
                        </br>
                        <button type="submit" class=button" name="add" value="${eventView.getEventId()}">
                            <fmt:message key="button.add"/></button>
                    </form>
                    <button type="submit" class=button" id="Cancel">
